...
public ReservaController(ReservaRepository reservaRepository,UserRepository userRepository, PacoteRepository pacoteRepository, ClienteRepository clienteRepository) {
...
this.pacoteRepository = pacoteRepository;
	...
	public ReservaDto findById(@PathVariable Long id) {
		var reserva= reservaRepository.findById(id).orElseThrow(()-> new NotFoundException("A reserva de id"+id+"não existe na base de dados"));
...
//				}
//			)
//	public ReservaDto update(@RequestBody ReservaDto reservaDto,JwtAuthenticationToken token) throws AccessDeniedException {
//		var user= userRepository.findById(UUID.fromString(token.getName()));
//		var reservaBd=reservaRepository.findById(reservaDto.getReservaId()).orElseThrow(()-> new ResourceNotFoundException("Reserva de id"+reservaDto.getReservaId()+" não encontrada na base de dados"));
